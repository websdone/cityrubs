...
jQuery( document ).ready(
	function(){
		...
		*-----------------------------------------*/
		...
		jQuery( '#bupr_excluding_box' ).selectize();
		jQuery( '.bupr_mt_criteria_select' ).selectize({
		...
		*--------------------------------------------------------*/
		jQuery( document ).on(
			'click', '#bupr-save-general-settings', function(){
		...
		*--------------------------------------------------------*/
		jQuery( document ).on(
			'change', '#bupr_allow_multiple_criteria', function(){
				if ( jQuery( this ).is( ':checked' ) ) {
		...
		*--------------------------------------------------------*/
		jQuery( document ).on(
			'click', '#bupr-save-criteria-settings', function(){
				jQuery( this ).addClass( 'bupr-btn-ajax' );
				jQuery( '.bupr-admin-settings-spinner' ).show();
		...
		*----------------------------------------------------------*/
		jQuery( document ).on(
			'click', '#bupr-save-display-settings', function(){
				jQuery( this ).addClass( 'bupr-btn-ajax' );
				jQuery( '.bupr-admin-settings-spinner' ).show();
				/* wbcom get all options value */
		...
		jQuery( document ).on(
			'click', '.bupr-approve-review', function(){
