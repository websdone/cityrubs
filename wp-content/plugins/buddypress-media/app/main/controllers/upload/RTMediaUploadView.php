		...
		$upload_tabs = array(
			'file_upload' => array(
				...
				'content' => '<div class="rtm-upload-tab-content" data-id="rtm-upload-tab">'
					...
					. '<div class="rtm-select-files"><input id="' . apply_filters( 'rtmedia_upload_button_id', 'rtMedia-upload-button' ) . '" value="' . esc_attr__( 'Select or drop your files', 'buddypress-media' ) . '" type="button" class="rtmedia-upload-input rtmedia-file" />'
					. '<span class="rtm-seperator">' . esc_html__( '', 'buddypress-media' ) . '</span><span class="drag-drop-info">' . esc_html__( ' max 6 files (photos/video)', 'buddypress-media' ) . '</span> <i class="rtm-file-size-limit rtmicon-info-circle rtmicon-fw"></i></div>'
