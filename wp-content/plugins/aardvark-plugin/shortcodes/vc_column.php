...
// Begin Mod - Background position
if ( isset( $atts['background_position'] ) && $atts['background_position'] != 'center center' ) {
	$style = ' style="background-position: ' . $atts['background_position'] . ' !important;"';
} else {
	$style = '';
}
// End Mod
