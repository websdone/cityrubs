...
// Begin Mod - Primary color style
if ( isset( $atts['hover_background_color'] ) && $atts['hover_background_color'] == 'gp-primary-color' ) {
	$hover_background_color_class = $atts['hover_background_color'];
	$atts['hover_background_color'] = '';
} else {
	$hover_background_color_class = '';
}
// End Mod

$template = <<<HTML
<div class="vc-hoverbox-wrapper $css_class $shape $align $reverse $width $hover_background_color_class" $id>
