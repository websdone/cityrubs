...
if ( 'custom' === $style ) {
	...
	// Begin Mod - Background hover color
	if ( isset( $atts['custom_background_hover'] ) && $atts['custom_background_hover'] ) {
		$onmouseenter = array();
		$onmouseenter[] = 'this.style.backgroundColor=\'' . $atts['custom_background_hover'] . '\';';
		if ( $onmouseenter ) {
			$attributes[] = 'onmouseleave="this.style.backgroundColor=\'' . $custom_background . '\'"';
			$attributes[] = 'onmouseenter="this.style.backgroundColor=\'' . $atts['custom_background_hover'] . '\'"';
		}
	}
	// End Mod
