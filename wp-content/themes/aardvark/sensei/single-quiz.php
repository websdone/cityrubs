	...
	<?php if ( sensei_can_user_view_lesson() ) : ?>
		...
		<div class="gp-entry-content">
	        ...
	        <?php if ( sensei_quiz_has_questions() ): ?>
	            ...
	            <form method="POST" action="<?php echo esc_url_raw( get_permalink() ); ?>" enctype="multipart/form-data" class="gp-quiz-form">
	        ...
	        <?php else:  ?>
	            ...
	            <div class="sensei-message alert"> <?php esc_html_e( 'There are no questions for this Quiz yet. Check back soon.', 'aardvark' ); ?></div>
